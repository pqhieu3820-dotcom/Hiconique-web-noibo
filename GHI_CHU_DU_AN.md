...
Đã đẩy hết lên GitHub tính tới phiên 2026-09-21. Phiên 2026-09-22 (xem mục ngay dưới) đã COMMIT LOCAL, **CHƯA PUSH** — chờ người dùng gõ "push". Apps Script đã redeploy lên **phiên bản 74** (thêm cột `Hiển thị`/`visible` cho tasks/projects + action `updateTasksBatch`/`updateProjectsBatch` — xem mục ngay dưới).

### Phiên 2026-09-22 — Fix bug đồng bộ 2 chiều + cột Ẩn/Hiện cho task-dự án + mở quyền tạo dự án + sửa cấp bậc thành viên
