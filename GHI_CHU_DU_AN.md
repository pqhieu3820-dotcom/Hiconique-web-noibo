...
Không có việc gì đang dở dang trong code — mọi thay đổi đã push lên GitHub (Cloudflare tự deploy bản web). Apps Script vẫn ở phiên bản 65 (không đổi thêm trong phiên 2026-09-17, chỉ sửa code phía web).

**Việc CẦN người dùng tự làm (không phải code)**: mở lại app trên điện thoại 1 lần (có mạng) để Service Worker mới cài vào — trang sẽ tự reload 1 lần rồi từ đó về sau code mới luôn hiện ngay, không cần thao tác gì thêm.

### Phiên 2026-09-17 — sửa hàng loạt lỗi người dùng phản ánh khi dùng thật
